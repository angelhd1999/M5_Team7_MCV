...
def save_coco(file, info, licenses, images, annotations):#!, categories):
    with open(file, 'wt', encoding='UTF-8') as coco:
        # json.dump({ 'info': info, 'licenses': licenses, 'images': images, #! Edited
        #     'annotations': annotations, 'categories': categories}, coco, indent=2, sort_keys=True)
        json.dump({ 'info': info, 'licenses': licenses, 'images': images, 
            'annotations': annotations}, coco, indent=2, sort_keys=True)
...
def main(args):
    ...
    with open(args.annotations, 'rt', encoding='UTF-8') as annotations:
        ...
        categories = None #!coco['categories']
        ...
        if args.multi_class:
            ...
            save_coco(args.train, info, licenses, X_train, anns_train)#, categories) #! Edited
            save_coco(args.test, info, licenses, X_test, anns_test)#, categories) #! Edited
